...
BLOG_AUTHOR = "Alexandre Paloschi Horta"  # (translatable)
BLOG_TITLE = "Buey - Software and Stuff"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.buey.net.br/"
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="/pages/license/" rel="nofollow">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
