...
/** Insert a stylesheet for the keyboard. */
// Create our shared stylesheet:
const sheet = new CSSStyleSheet();
sheet.replaceSync('#kbd { float: left; text-align: center; padding: 15px; border-style: none; border-spacing: 2px; background-color: #000fff; }');
sheet.replaceSync('#kbd td { padding: 5px; }');
sheet.replaceSync('#kbd .key { min-width: 32px; border: 2px solid #aaa; border-radius: 6px; color: #333; background-color: #ccc; }');
sheet.replaceSync('#kbd .mode { font-size: 74% }');
sheet.replaceSync('#kbd .active { border: 2px solid red; font-weight: bold; color: #000; background-color: #ececec; }');
